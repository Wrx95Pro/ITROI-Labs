...
public class Stax2Parser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Album> albums = parser.parse(new FileInputStream(Const.XML_FILE), Const.XSD_FILE);
        System.out.println("====================================");
        System.out.println("Here is the albums: \n" + albums);
        System.out.println("====================================");
		albums = parser.parse(new FileInputStream(Const.INVALID_XML_FILE), Const.XSD_FILE);
        System.out.println("====================================");
        System.out.println("Here is the invalid albums: \n" + albums);
        System.out.println("====================================");
    }

    private List<Album> parse(InputStream in, String schemaFile) throws XMLStreamException {
