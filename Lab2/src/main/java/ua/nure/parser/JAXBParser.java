...
public class JAXBParser {
     ...
     */
    public static Albums loadAlbums(final String xmlFileName,
        ...
        // do unmarshal
        Albums albums = (Albums) unmarshaller.unmarshal(new File(xmlFileName));
        return albums; // <-- filled container
    }
     ...
     */
    public static void saveAlbums(Albums albums, final String xmlFileName,
                                  final String xsdFileName, Class<?> objectFactory) throws JAXBException, SAXException {
        JAXBContext jc = JAXBContext.newInstance(objectFactory);
        ...
        marshaller.marshal(albums, new File(xmlFileName));
    }
    ...
    public static void main(String[] args) throws JAXBException, SAXException {
        ...
        // warning)
//        Albums albums = loadAlbums(Const.XML_FILE, Const.XSD_FILE, Const.OBJECT_FACTORY);

        Albums albums = new Albums();
        var album = new Album();
        album.setAccessLevel(AccessLevel.PUBLIC);
        album.setDate("testDate");
        album.setId(1);
        album.setHeader("testHeader");
        album.setText("testText");
        ...
        try {
            saveAlbums(albums, Const.XML_FILE + ".jaxb.xml", Const.XSD_FILE, Const.OBJECT_FACTORY);
        } catch (Exception ex) {
            System.err.println("====================================");
